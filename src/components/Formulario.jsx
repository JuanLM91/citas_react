  ...
  return (
    <div className='md:w-1/2 lg:w-2/5'>
      ...
      <form 
        ...
        className='bg-white shadow-md rounded-lg py-10 px-5 mt-10 md:ml-10 mx-5'
      >
        { error && (
        ...
        <div className='mb-5'>
          ...
          <input
            id='mascota' 
            type="text"
            placeholder='Nombre de la masota'
        ...
        <input 
          type="submit" 
          className='w-full bg-indigo-600 border-2 rounded-md text-white py-2 font-bold uppercase hover:bg-indigo-800 transition delay-85 '
